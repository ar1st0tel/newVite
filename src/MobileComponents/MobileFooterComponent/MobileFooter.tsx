    ...
    <div className={classes.footerMobile}>
      <div className={classes.footerTop}>
        ...
        <div className={classes.socials}>
          <div>
            <img src={Inst} className={classes.socialsItem} alt="logo" />
          </div>
          <div>
            <img src={FB} className={classes.socialsItem} alt="logo" />
          </div>
          <div>
            <img src={LinkedIn} className={classes.socialsItem} alt="logo" />
          </div>
          <div>
            <img src={Twitter} className={classes.socialsItem} alt="logo" />
          </div>
        </div>
      </div>
